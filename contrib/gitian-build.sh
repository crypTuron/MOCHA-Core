...
VERSION=
commit=false
url=https://github.com/MochaChainOSS/MOCHA-Core
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the mochachain, gitian-builder, gitian.sigs, and mochachain-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/MochaChainOSS/MOCHA-Core
...
then
	# Make output folder
	mkdir -p "./mochachain-binaries/${VERSION}"
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mochachain=${COMMIT} --url mochachain=${url} ../mochachain/contrib/gitian-descriptors/gitian-linux.yml
	    ...
	    mv build/out/mochachain-*.tar.gz build/out/src/mochachain-*.tar.gz ../mochachain-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mochachain=${COMMIT} --url mochachain=${url} ../mochachain/contrib/gitian-descriptors/gitian-win.yml
	    ...
	    mv build/out/mochachain-*.zip build/out/mochachain-*.exe ../mochachain-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mochachain=${COMMIT} --url mochachain=${url} ../mochachain/contrib/gitian-descriptors/gitian-osx.yml
	    ...
	    mv build/out/mochachain-*.tar.gz build/out/mochachain-*.dmg ../mochachain-binaries/${VERSION}
	fi
	# AArch64
	if [[ $aarch64 = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mochachain=${COMMIT} --url mochachain=${url} ../mochachain/contrib/gitian-descriptors/gitian-aarch64.yml
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../mochachain/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/mochachain-*.tar.gz build/out/src/mochachain-*.tar.gz ../mochachain-binaries/${VERSION}
	fi
	popd || exit
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../mochachain/contrib/gitian-descriptors/gitian-win-signer.yml
	    ...
	    mv build/out/mochachain-*win64-setup.exe ../mochachain-binaries/${VERSION}
	    mv build/out/mochachain-*win32-setup.exe ../mochachain-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../mochachain/contrib/gitian-descriptors/gitian-osx-signer.yml
	    ...
	    mv build/out/mochachain-osx-signed.dmg ../mochachain-binaries/${VERSION}/mochachain-${VERSION}-osx.dmg
	fi
	popd || exit
