Contributing to MochaChain Core
============================

The MochaChain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MochaChain Core project, and is not to be
confused with overall MochaChain Network Protocol consensus changes.

Whether a pull request is merged into MochaChain Core rests with the project merge
...
Patches that change MochaChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the MochaChain consensus, it must have been
...
The project leader is the release manager for each MochaChain Core release.
