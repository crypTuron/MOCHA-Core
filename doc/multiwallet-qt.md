...
In order to support loading of multiple wallets in mochachain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mochachain.cpp.
...
Changes to mochachain.cpp
----------------------
mochachain.cpp is the entry point into mochachain-qt, and as such, will require some minor modifications to provide hooks for
