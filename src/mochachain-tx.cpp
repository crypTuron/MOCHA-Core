...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MochaChain Core mochachain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mochachain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mochachain transaction") + "\n" +
                               "  mochachain-tx [options] -create [commands]   " + _("Create hex-encoded mochachain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mochachain transaction
