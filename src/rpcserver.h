...
/**
 * MochaChain RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzmochaseed(const UniValue& params, bool fHelp);
extern UniValue getzmochaseed(const UniValue& params, bool fHelp);
