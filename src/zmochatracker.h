...
#ifndef MOCHACHAIN_ZMOCHATRACKER_H
#define MOCHACHAIN_ZMOCHATRACKER_H
...
public:
    CzMOCHATracker(std::string strWalletFile);
    ~CzMOCHATracker();
...
#endif //MOCHACHAIN_ZMOCHATRACKER_H
