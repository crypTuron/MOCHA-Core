...
public:
    ...
    bool WriteZMOCHASeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMOCHASeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMOCHASeed_deprecated(uint256& seed);
    bool EraseZMOCHASeed();
    bool EraseZMOCHASeed_deprecated();

    bool WriteZMOCHACount(const uint32_t& nCount);
    bool ReadZMOCHACount(uint32_t& nCount);
