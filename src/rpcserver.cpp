...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MochaChain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MochaChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MochaChain features */
        {"mochachain", "masternode", &masternode, true, true, false},
        {"mochachain", "listmasternodes", &listmasternodes, true, true, false},
        {"mochachain", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mochachain", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mochachain", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mochachain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mochachain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mochachain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mochachain", "masternodedebug", &masternodedebug, true, true, false},
        {"mochachain", "startmasternode", &startmasternode, true, true, false},
        {"mochachain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mochachain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mochachain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mochachain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mochachain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mochachain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mochachain", "mnbudget", &mnbudget, true, true, false},
        {"mochachain", "preparebudget", &preparebudget, true, true, false},
        {"mochachain", "submitbudget", &submitbudget, true, true, false},
        {"mochachain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mochachain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mochachain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mochachain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mochachain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mochachain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mochachain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mochachain", "checkbudgets", &checkbudgets, true, true, false},
        {"mochachain", "mnsync", &mnsync, true, true, false},
        {"mochachain", "spork", &spork, true, true, false},
        {"mochachain", "getpoolinfo", &getpoolinfo, true, true, false},
        {"mochachain", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzmochaseed", &getzmochaseed, false, false, true},
        {"zerocoin", "setzmochaseed", &setzmochaseed, false, false, true}
...
{
    return "> mochachain-cli " + methodname + " " + args + "\n";
}
