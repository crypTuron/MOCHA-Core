...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MochaChain Core"),
     ...
     * override -datadir in the mochachain.conf file in the default data directory
     * (to be consistent with mochachaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
