                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzmochaPathCustom = GetArg("-zmochabackuppath", "");
    ...
    if(!strzmochaPathCustom.empty()) {
        ui->wallet_customzmochabackuppath->setText(QString::fromStdString(strzmochaPathCustom));
        ui->wallet_customzmochabackuppath_label->setVisible(true);
        ui->wallet_customzmochabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzmochaPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MochaChain RPC console.") + "<br>" +
