 ...
 */
    ...
    typeWidget->addItem(tr("Received Mocha from zMocha"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMocha"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMocha));
