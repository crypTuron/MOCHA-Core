                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MochaChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MochaChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mochachain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMOCHA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MochaChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about MochaChain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MochaChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MochaChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MochaChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a MochaChain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MochaChain Core help message to get a list with possible MochaChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MochaChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MochaChain network", "", count));
}
...
{
    QString strTitle = tr("MochaChain Core"); // default title
