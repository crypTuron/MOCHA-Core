...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(mMOCHA);
    unitlist.append(uMOCHA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MOCHA:
        return QString("mochachain");
    case mMOCHA:
        return QString("mmochachain");
    case uMOCHA:
        return QString::fromUtf8("umochachain");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case uMOCHA:
            return QString::fromUtf8("μMOCHA");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MOCHA:
            return QString("tMOCHA");
        case mMOCHA:
            return QString("mtMOCHA");
        case uMOCHA:
            return QString::fromUtf8("μtMOCHA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case MOCHA:
            return QString("TestMOCHAs");
        case mMOCHA:
            return QString("Milli-TestMOCHA (1 / 1" THIN_SP_UTF8 "000)");
        case uMOCHA:
            return QString("Micro-TestMOCHA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
