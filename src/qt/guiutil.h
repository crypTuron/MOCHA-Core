...
/** Utility functions used by the MochaChain Qt UI.
 */
namespace GUIUtil
{
...
// Render MochaChain addresses in monospace font
...
// Parse "mochachain:" URI into recipient object, return true on successful parsing
