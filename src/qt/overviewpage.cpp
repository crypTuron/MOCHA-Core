...
// Copyright (c) 2017-2019 MochaChain LLC
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::MOCHA)
    {
    }
...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sMOCHAPercentage, QString& szMOCHAPercentage)
{
    int nPrecision = 2;
    ...
    szMOCHAPercentage = "(" + QLocale(QLocale::system()).toString(dzPercentage, 'f', nPrecision) + " %)";
    sMOCHAPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount mochaAvailableBalance = balance - immatureBalance - nLockedBalance;
    ...
    // Combined balances
    CAmount availableTotalBalance = mochaAvailableBalance + matureZerocoinBalance;
    CAmount sumTotalBalance = nTotalBalance + zerocoinBalance;

    // MOCHA labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnitComma(nDisplayUnit, mochaAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // Percentage labels
    ui->labelMOCHAPercent->setText(sPercentage);
    ui->labelzMOCHAPercent->setText(szPercentage);

    // Adjust bubble-help according to AutoMint settings
    QString automintHelp = tr("Current percentage of zMOCHA.\nIf AutoMint is enabled this percentage will settle around the configured AutoMint percentage (default = 10%).\n");
    bool fEnableZeromint = GetBoolArg("-enablezeromint", false);
    int nZeromintPercentage = GetArg("-zeromintpercentage", 10);
    if (fEnableZeromint) {
        automintHelp += tr("AutoMint is currently enabled and set to ") + QString::number(nZeromintPercentage) + "%.\n";
        automintHelp += tr("To disable AutoMint add 'enablezeromint=0' in mochachain.conf.");
    }
    else {
        automintHelp += tr("AutoMint is currently disabled.\nTo enable AutoMint change 'enablezeromint=0' to 'enablezeromint=1' in mochachain.conf");
    }
    ...
    bool showMOCHAAvailable = settingShowAllBalances || mochaAvailableBalance != nTotalBalance;
    bool showWatchOnlyMOCHAAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showMOCHAPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyMOCHAPending = watchUnconfBalance != 0;
    bool showMOCHALocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyMOCHALocked = nWatchOnlyLockedBalance != 0;
    bool showImmature = settingShowAllBalances || immatureBalance != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;
    bool showWatchOnly = nTotalWatchBalance != 0;
    ui->labelBalance->setVisible(showMOCHAAvailable || showWatchOnlyMOCHAAvailable);
    ui->labelBalanceText->setVisible(showMOCHAAvailable || showWatchOnlyMOCHAAvailable);
    ui->labelWatchAvailable->setVisible(showMOCHAAvailable && showWatchOnly);
    ui->labelUnconfirmed->setVisible(showMOCHAPending || showWatchOnlyMOCHAPending);
    ui->labelPendingText->setVisible(showMOCHAPending || showWatchOnlyMOCHAPending);
    ui->labelWatchPending->setVisible(showMOCHAPending && showWatchOnly);
    ui->labelLockedBalance->setVisible(showMOCHALocked || showWatchOnlyMOCHALocked);
    ui->labelLockedBalanceText->setVisible(showMOCHALocked || showWatchOnlyMOCHALocked);
    ui->labelWatchLocked->setVisible(showMOCHALocked && showWatchOnly);
    ...
    bool showzMOCHAAvailable = settingShowAllBalances || zerocoinBalance != matureZerocoinBalance;
    bool showzMOCHAUnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showzMOCHAImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
    ui->labelzBalanceMature->setVisible(showzMOCHAAvailable);
    ui->labelzBalanceMatureText->setVisible(showzMOCHAAvailable);
    ui->labelzBalanceUnconfirmed->setVisible(showzMOCHAUnconfirmed);
    ui->labelzBalanceUnconfirmedText->setVisible(showzMOCHAUnconfirmed);
    ui->labelzBalanceImmature->setVisible(showzMOCHAImmature);
    ui->labelzBalanceImmatureText->setVisible(showzMOCHAImmature);
    bool showPercentages = ! (zerocoinBalance == 0 && nTotalBalance == 0);
    ui->labelMOCHAPercent->setVisible(showPercentages);
    ui->labelzMOCHAPercent->setVisible(showPercentages);
