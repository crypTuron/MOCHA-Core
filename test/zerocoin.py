...
#   c) node1 mines 32 blocks, so now node 0 has 60001mocha, node 1 has 4250mocha, node2 has none.
#   d) node0 sends 601 mocha to node2, in two transactions (301 mocha, then 300 mocha).
